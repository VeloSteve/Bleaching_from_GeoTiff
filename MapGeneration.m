...
% last updated: 1-6-15                                                          %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [] = MapGeneration(Reefs_latlon, values, year)
...
tName = strcat({'Donner Bleaching Probabilities for '}, num2str(year));
% Green points everywhere
oneMapPoints(Reefs_latlon(:, 1), Reefs_latlon(:, 2), values, parula, tName);
...
function [] = oneMapPoints(lons, lats, values, cMap, t)
    f = figure();
...
% t title
% outFile pdf output file
function [] = oneMapBoxes(n, lons, lats, values, cMap, t)
    f = figure(n);
